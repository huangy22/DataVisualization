...
var yFit = "EduMonthFit";

var innerWidth  = outerWidth  - margin.left - margin.right;
var innerHeight = outerHeight - margin.top  - margin.bottom;

var svg = d3.select("#line_edu_working").append("svg")
...
function render(data){
  ...
  var legends = g.append("g")
    .attr("class","legend")
    .attr("transform", "translate(" + innerWidth*1/2 + "," + innerHeight*2/3 + ")")
    .attr("x", 0)
    .attr("y", 0)
    .attr("height", 100)
    .attr("width", 100);
  ...
  .attr("x", 15)
    .attr("y", 30)
    .text("Linear Regression: y = 1.86+0.17x")
    .style("text-anchor", "front");
}
