...
var outerWidth = 650;
var outerHeight = 400;
var margin = { left: 80, top: 30, right: 30, bottom:130 };

var xColumn = "EduLevel";
var yColumn = "Income_median";
var yFit = "EduIncomeFit";

var innerWidth  = outerWidth  - margin.left - margin.right;
var innerHeight = outerHeight - margin.top  - margin.bottom;

var svg = d3.select("#line_edu_income_2").append("svg")
...
function render(data){
  ...
  yAxisG.append("text")
    ...
    .text("The Median of Monthly Income");
